...
File Name: Wsimple/rest_api/errors.py
...
class OTPCallbackNone(Exception):
    ...
    def __init__(self):
        super(OTPCallbackNone, self).__init__(
            "An connection otp user account was triggered, please use a callback function"
        )
...
class WSOTPError(Exception):
    ...
    def __init__(self):
        super(WSOTPError, self).__init__(
            "An Wealthsimple otp error happend, please try again and use a try block"
        )
...
class WSOTPLoginError(Exception):
    ...
    def __init__(self):
        super(WSOTPLoginError, self).__init__(
            "An Wealthsimple otp login error happend, please try again"
        )
