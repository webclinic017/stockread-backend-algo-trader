...
class Endpoints(Enum):
    ...
    GET_SUMMARY_STATUS = Route("{base}rest_api/v2/summary.json", "GET")
    GET_CURRENT_STATUS = Route("{base}rest_api/v2/status.json", "GET")
    GET_HISTORICAL_STATUS = Route("{base}rest_api/v2/incidents.json", "GET")
